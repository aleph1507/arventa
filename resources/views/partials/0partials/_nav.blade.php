...
<header id="hero-area" style="background: url({{secure_asset('img/street-wallpaper.jpg')}}); background-size: cover;">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top scrolling-navba bg-faded" id="white-bg">
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{url('/')}}"><img src="{{secure_asset('img/logo.png')}}" alt=""></a>
      </div>
